...
// CONCATENATED MODULE: ./src/package/src/main.vue?vue&type=template&id=567deea1&
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    setBCR: function setBCR() {
      ...
      var width = this.computePrimitiveValue(this.dialogWidth || this.width, clientWidth);
      var height = this.computePrimitiveValue(this.dialogHeight || this.height, clientHeight);
      var minWidth = this.computePrimitiveValue(this.dialogMinWidth || this.minWidth, clientWidth);
      var maxWidth = this.computePrimitiveValue(this.dialogMaxWidth || this.maxWidth, clientWidth);
      var minHeight = this.computePrimitiveValue(this.dialogMinHeight || this.minHeight, clientHeight);
      var maxHeight = this.computePrimitiveValue(this.dialogMaxHeight || this.maxHeight, clientHeight);
      ...
      var left = this.computePrimitiveValue(isNumeric($left) ? $left : $left || (clientWidth - $width) / 2, clientWidth);
      var top = this.computePrimitiveValue(isNumeric($top) ? $top : $top || (clientHeight - $height) / 2, clientHeight);
      var dialogBCR = {
        width: width,
        minWidth: minWidth,
        maxWidth: maxWidth,
...
var component = normalizeComponent(
  ...
  mainvue_type_template_id_567deea1_render,
  staticRenderFns,
  false,
  null,
  null,
...
package_vueHDialog.install = function install(Vue) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      _ref$compnentName = _ref.compnentName,
      compnentName = _ref$compnentName === void 0 ? 'VueDialog' : _ref$compnentName,
  ...
  Vue.component(compnentName || src_main.name, src_main);
};
